...
export default function PricingPage() {
  ...
  // Correct mapping: $199 → Silver, $500 → Gold
  const silverLink = process.env.NEXT_PUBLIC_STRIPE_SILVER_LINK || 'https://buy.stripe.com/dRm6oH6nBfhMbkg64a0gw00'
  const goldLink = process.env.NEXT_PUBLIC_STRIPE_GOLD_LINK || 'https://buy.stripe.com/5kQ7sL9zN1qW1JGakq0gw01'
