        ...
        <div className="bg-gray-800/90 backdrop-blur-sm p-8 rounded-lg max-w-2xl mx-auto mb-16">
          ...
          >
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-describedby={status !== 'idle' ? 'subscription-status' : undefined}
                  className="w-full pl-12 p-3 rounded bg-gray-700 text-white border border-gray-600 focus:border-gold focus:outline-none focus:ring-2 focus:ring-gold focus:ring-opacity-50 font-medium"
            ...
            <button
              ...
              className="w-full bg-gold text-navy-blue py-3 px-6 rounded font-semibold hover:bg-opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-gold focus:ring-opacity-50"
            >
